	...
	<ul class="nav user-menu">
		...
		<li class="nav-item dropdown noti-dropdown">
			...
			<div class="dropdown-menu notifications">
				<div class="topnav-dropdown-header">
					...
					<a href="{{route('mark-as-read')}}" class="clear-noti">Marcar todo como leido </a>
				</div>
									...
									<div class="media">
										...
										<div class="media-body">
											...
											<p class="noti-details">
												...
												<span>Por favor actualice la cantidad de compra </span>
											</p>
		...
		<li class="nav-item dropdown has-arrow">
			...
			<div class="dropdown-menu">
				...
				@can('view-settings')<a class="dropdown-item" href="{{route('settings')}}">Configuracion</a>@endcan

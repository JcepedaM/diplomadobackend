	...
	<div class="col-md-12">
		...
		<div class="profile-menu">
			<ul class="nav nav-tabs nav-tabs-solid">
				<li class="nav-item">
					<a class="nav-link active" data-toggle="tab" href="#per_details_tab">Info</a>
				</li>
				<li class="nav-item">
					...
					<div class="col-lg-12">
						<div class="card">
							<div class="card-body">
								...
								<div class="row">
									<p class="col-sm-2 text-muted text-sm-right mv-0 mb-sm-3">Rol del usuario</p>
									<p class="col-sm-10">
							...
							<div class="col-md-10 col-lg-12">
								<form method="POST" action="{{route('update-password',auth()->user())}}">
									...
									<div class="form-group">
										...
										<input type="password" name="password" class="form-control" placeholder="Ingresa la nueva contraseña">
									</div>
									<div class="form-group">

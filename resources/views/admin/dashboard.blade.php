...
@push('page-header')
<div class="col-sm-12">
	<h3 class="page-title">Bienvenid@ {{auth()->user()->name}}!</h3>
	<ul class="breadcrumb">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="dash-widget-info">
                    <h6 class="text-muted">Dinero de las ventas de hoy</h6>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="dash-widget-info">
                    ...
                    <h6 class="text-muted">Categorias de producto</h6>
                    <div class="progress progress-sm">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="dash-widget-info">
                    ...
                    <h6 class="text-muted">Cuentas creadas</h6>
                    <div class="progress progress-sm">
